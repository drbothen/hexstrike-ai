...
class FlaskAdapter:
    ...
    def __init__(self, app: Flask):
        ...
        self.route_registrar = RouteRegistrar(app, self._get_current_timestamp)
    ...
    def register_routes(self) -> None:
        """Register all API routes using the route registrar"""
        self.route_registrar.register_all_routes()
